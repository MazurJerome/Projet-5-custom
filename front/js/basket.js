...
function changeQuantity(product, quantity, color) {
	const foundProduct = basket.filter((p) => p.id === product); //[id option[{}{}]]
	const option = foundProduct[0].option;
